...
public class CalendarGridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // iv.setDescendantFocusability(focusability);
        ...
        TextView txtDay = new TextView(activity);// 国历
...
//            iv.setBackgroundColor(resources.getColor(R.color.event_center));
       ...
       //     iv.setBackgroundColor(resources.getColor(R.color.selection));
        ...
        if (iMonth == iMonthViewCurrentMonth) {
            txtToDay.setTextColor(resources.getColor(R.color.ToDayText)); //当月农历字体颜色
            txtDay.setTextColor(resources.getColor(R.color.Text));			//当月国历字体颜色
        } else {
            txtDay.setTextColor(resources.getColor(R.color.noMonth));    //非本月国历字体颜色
            txtToDay.setTextColor(resources.getColor(R.color.noMonth));	//非本月农历字体颜色
        }
        // 判断周六周日
